<?php
	...
	$data_laporan=mysql_query("SELECT data_penipu.id_pnp,
							   ...
							   WHERE data_penipu.status=0 ORDER BY data_penipu.log DESC LIMIT $MulaiAwal, $BatasAwal") or die(mysql_error());
?>
					  ...
					  while ($laporanin=mysql_fetch_array($data_laporan)) {?>
					  	<tr>
					  		...
					  		<td class="text-center">
					  			<a style="margin:5px" class="btn-success btn-sm" href="../sys/terima_laporan.php?data-page=laporan-masuk&id=<?php echo $laporanin['id_pnp'];?>">
					  			...
					  			<a style="margin:5px" data-value="../sys/hapus_laporan.php?page=laporan&id=<?php echo $laporanin['id_pnp'];?>" class="hapus btn-danger btn-sm">
  		...
  		<div class="panel-footer text-center">
  			<ul class="pagination pagination-sm">
  				<?php
					...
					echo '" ><a href="?page=laporan&hal=' . $i . '">' . $i . '</a> ';
					}
					echo '</li>';
					}else{
